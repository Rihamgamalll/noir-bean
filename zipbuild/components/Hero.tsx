      ...
      >
        <div ref={background} className="absolute inset-0">
          ...
          <Image
            ...
            quality={72}
            sizes="100vw"
            className="object-cover object-[51%_center] md:hidden"
          />
        ...
        {/* Mobile-only detail windows sampled from the same background image.
            They reveal the real sack and pastry case behind the cup, not new assets. */}
        <div
          aria-hidden
          className="pointer-events-none absolute bottom-[3svh] left-[-34px] z-[11] h-[235px] w-[220px] overflow-hidden md:hidden"
          style={{
            ...
            WebkitMaskImage:
              "radial-gradient(ellipse 86% 88% at 45% 58%, #000 56%, transparent 100%)",
            maskImage:
              "radial-gradient(ellipse 86% 88% at 45% 58%, #000 56%, transparent 100%)",
          }}
        />
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute bottom-[2svh] right-[-42px] z-[11] h-[285px] w-[230px] overflow-hidden md:hidden"
          style={{
            backgroundImage: "url('/Coffe.png')",
            backgroundRepeat: "no-repeat",
            backgroundSize: "760px auto",
            ...
            WebkitMaskImage:
              "radial-gradient(ellipse 88% 90% at 58% 58%, #000 58%, transparent 100%)",
            maskImage:
              "radial-gradient(ellipse 88% 90% at 58% 58%, #000 58%, transparent 100%)",
          }}
        />
          ...
          <div className="max-w-[500px] md:max-w-[500px] lg:-translate-y-5">
            ...
            <h1
              className="
                font-serif
                max-w-[360px]
                text-[clamp(2.25rem,10.5vw,3.45rem)]
                leading-[0.9]
                tracking-[-0.045em]
            ...
            <p
              data-description
              className="mt-5 max-w-[350px] text-[12px] leading-[1.65] text-white/88 sm:max-w-[430px] sm:text-[13px] md:mt-6 md:text-[15px]"
            >
            ...
            <div data-actions className="mt-6 flex flex-nowrap gap-3 sm:mt-7">
              <a
                href="/menu"
